...
public class CreateMessageCallerHttp2 extends MessageServiceCallerBase {
    ...
    public CreateMessageCallerHttp2(int callCount, MessageServiceTestHelper testHelper, String uri) {
